...
const typographyVariants = cva("", {
  variants: {
    variant: {
      /**
       * New semantic variants for the design system, extracted from recent implementations of
       * design mockups generated by Codex ImageGen I was pleased with. I am considering using them
