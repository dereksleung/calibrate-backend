...
describe("BrevoEmailSender", () => {
  ...
  it("sends signup recovery-email copy with a challenge-scoped idempotency key", async () => {
    ...
    await new BrevoEmailSender("test-api-key").sendSignupEmailVerificationCode({
    ...
    expect(body.htmlContent).toContain("verify your recovery email");
